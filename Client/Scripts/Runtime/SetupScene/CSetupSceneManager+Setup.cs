...
namespace SetupScene
{
	...
	public abstract partial class CSetupSceneManager : CSceneManager
	{
		...
		private void SetupPopupUIs()
		{
			...
			{
				CSetupSceneManager.m_oPopupUIs = CFactory.CreateCloneGameObj(KCDefine.U_OBJ_N_SCREEN_POPUP_UIS, CResManager.Inst.GetRes<GameObject>(KCDefine.SS_OBJ_P_SCREEN_POPUP_UIS), null);
		...
		private void SetupTopmostUIs()
		{
			...
			{
				CSetupSceneManager.m_oTopmostUIs = CFactory.CreateCloneGameObj(KCDefine.U_OBJ_N_SCREEN_TOPMOST_UIS, CResManager.Inst.GetRes<GameObject>(KCDefine.SS_OBJ_P_SCREEN_TOPMOST_UIS), null);
		...
		private void SetupAbsUIs()
		{
			...
			{
				CSetupSceneManager.m_oAbsUIs = CFactory.CreateCloneGameObj(KCDefine.U_OBJ_N_SCREEN_ABS_UIS, CResManager.Inst.GetRes<GameObject>(KCDefine.SS_OBJ_P_SCREEN_ABS_UIS), null);
		...
		private void SetupTimerManager()
		{
			...
			{
				CSetupSceneManager.m_oTimerManager = CFactory.CreateCloneGameObj(KCDefine.SS_OBJ_N_TIMER_MANAGER, CResManager.Inst.GetRes<GameObject>(KCDefine.U_OBJ_P_TIMER_MANAGER), null);
			}
		}
		#endregion // 함수
		...
		private void SetupDebugUIs()
		{
			...
			{
				CSetupSceneManager.m_oDebugUIs = CFactory.CreateCloneGameObj(KCDefine.U_OBJ_N_SCREEN_DEBUG_UIS, CResManager.Inst.GetRes<GameObject>(KCDefine.SS_OBJ_P_SCREEN_DEBUG_UIS), null);
