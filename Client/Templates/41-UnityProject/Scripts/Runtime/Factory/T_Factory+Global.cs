...
public static partial class Factory {
	...
	public static CItemTargetInfo MakeItemTargetInfo(EItemKinds a_eItemKinds, CTargetInfo a_oOwnerTargetInfo = null) {
		...
		Factory.MakeDefAbilityTargetInfos().ExCopyTo(oItemTargetInfo.m_oAbilityTargetInfoDict, (_, a_stTargetInfo) => a_stTargetInfo, false);
	...
	public static CSkillTargetInfo MakeSkillTargetInfo(ESkillKinds a_eSkillKinds, CTargetInfo a_oOwnerTargetInfo = null) {
		...
		Factory.MakeDefAbilityTargetInfos().ExCopyTo(oSkillTargetInfo.m_oAbilityTargetInfoDict, (_, a_stTargetInfo) => a_stTargetInfo, false);
	...
	public static CObjTargetInfo MakeObjTargetInfo(EObjKinds a_eObjKinds, CTargetInfo a_oOwnerTargetInfo = null) {
		...
		Factory.MakeDefAbilityTargetInfos().ExCopyTo(oObjTargetInfo.m_oAbilityTargetInfoDict, (_, a_stTargetInfo) => a_stTargetInfo, false);
	...
	public static CAbilityTargetInfo MakeAbilityTargetInfo(EAbilityKinds a_eAbilityKinds, CTargetInfo a_oOwnerTargetInfo = null) {
		...
		Factory.MakeDefAbilityTargetInfos().ExCopyTo(oAbilityTargetInfo.m_oAbilityTargetInfoDict, (_, a_stTargetInfo) => a_stTargetInfo, false);
	...
	public static CCharacterUserInfo MakeCharacterUserInfo(EObjKinds a_eObjKinds, STIDInfo a_stIDInfo, STIdxInfo a_stIdxInfo) {
		...
		Factory.MakeDefAbilityTargetInfos().ExCopyTo(oCharacterUserInfo.m_oAbilityTargetInfoDict, (_, a_stTargetInfo) => a_stTargetInfo, false);
	...
	private static Dictionary<ulong, STTargetInfo> MakeDefAbilityTargetInfos() {
		return new Dictionary<ulong, STTargetInfo>() {
			[Factory.MakeUTargetInfoID(ETargetKinds.ABILITY_TARGET, (int)EAbilityKinds.STAT_ABILITY_LV)] = new STTargetInfo(ETargetKinds.ABILITY_TARGET, (int)EAbilityKinds.STAT_ABILITY_LV, new STValInfo(EValType.INT, KCDefine.B_VAL_0_INT)),
			[Factory.MakeUTargetInfoID(ETargetKinds.ABILITY_TARGET, (int)EAbilityKinds.STAT_ABILITY_EXP)] = new STTargetInfo(ETargetKinds.ABILITY_TARGET, (int)EAbilityKinds.STAT_ABILITY_EXP, new STValInfo(EValType.INT, KCDefine.B_VAL_0_INT)),
			[Factory.MakeUTargetInfoID(ETargetKinds.ABILITY_TARGET, (int)EAbilityKinds.STAT_ABILITY_NUMS)] = new STTargetInfo(ETargetKinds.ABILITY_TARGET, (int)EAbilityKinds.STAT_ABILITY_NUMS, new STValInfo(EValType.INT, KCDefine.B_VAL_0_INT)),
			[Factory.MakeUTargetInfoID(ETargetKinds.ABILITY_TARGET, (int)EAbilityKinds.STAT_ABILITY_ENHANCE)] = new STTargetInfo(ETargetKinds.ABILITY_TARGET, (int)EAbilityKinds.STAT_ABILITY_ENHANCE, new STValInfo(EValType.INT, KCDefine.B_VAL_0_INT))
		};
	}
	#endregion // 클래스 함수
