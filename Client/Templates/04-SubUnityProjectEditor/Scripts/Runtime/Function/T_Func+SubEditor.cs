...
#region 조건부 클래스 함수
	...
	/** 에디터 레벨 정보를 설정한다 */
	public static void SetupEditorLevelInfo(CLevelInfo a_oLevelInfo, CEditorCreateInfo a_oCreateInfo) {
	...
	/** 에디터 셀 정보를 설정한다 */
	private static void SetupEditorCellInfos(CLevelInfo a_oLevelInfo, CEditorCreateInfo a_oCreateInfo) {
