...
namespace NSEngine {
	...
	public static partial class Access {
		...
		public static STSortingOrderInfo GetSortingOrderInfo(EItemKinds a_eItemKinds, int a_nExtraOrder = KCDefine.B_VAL_0_INT, EKindsGroupType a_eGroupType = EKindsGroupType.SUB_KINDS_TYPE) {
			...
			return bIsValid ? stSortingOrderInfo.ExGetExtraOrder(a_nExtraOrder) : KDefine.E_SORTING_OI_ITEM_DICT.GetValueOrDefault((EItemKinds)((int)a_eItemKinds).ExKindsToCorrectKinds(a_eGroupType), STSortingOrderInfo.INVALID).ExGetExtraOrder(a_nExtraOrder);
		}
		...
		public static STSortingOrderInfo GetSortingOrderInfo(ESkillKinds a_eSkillKinds, int a_nExtraOrder = KCDefine.B_VAL_0_INT, EKindsGroupType a_eGroupType = EKindsGroupType.SUB_KINDS_TYPE) {
			...
			return bIsValid ? stSortingOrderInfo.ExGetExtraOrder(a_nExtraOrder) : KDefine.E_SORTING_OI_SKILL_DICT.GetValueOrDefault((ESkillKinds)((int)a_eSkillKinds).ExKindsToCorrectKinds(a_eGroupType), STSortingOrderInfo.INVALID).ExGetExtraOrder(a_nExtraOrder);
		}
		...
		public static STSortingOrderInfo GetSortingOrderInfo(EObjKinds a_eObjKinds, int a_nExtraOrder = KCDefine.B_VAL_0_INT, EKindsGroupType a_eGroupType = EKindsGroupType.SUB_KINDS_TYPE) {
			...
			return bIsValid ? stSortingOrderInfo.ExGetExtraOrder(a_nExtraOrder) : KDefine.E_SORTING_OI_OBJ_DICT.GetValueOrDefault((EObjKinds)((int)a_eObjKinds).ExKindsToCorrectKinds(a_eGroupType), STSortingOrderInfo.INVALID).ExGetExtraOrder(a_nExtraOrder);
		}
		...
		public static STSortingOrderInfo GetSortingOrderInfo(EFXKinds a_eFXKinds, int a_nExtraOrder = KCDefine.B_VAL_0_INT, EKindsGroupType a_eGroupType = EKindsGroupType.SUB_KINDS_TYPE) {
			...
			return bIsValid ? stSortingOrderInfo.ExGetExtraOrder(a_nExtraOrder) : KDefine.E_SORTING_OI_FX_DICT.GetValueOrDefault((EFXKinds)((int)a_eFXKinds).ExKindsToCorrectKinds(a_eGroupType), STSortingOrderInfo.INVALID).ExGetExtraOrder(a_nExtraOrder);
		}
		#endregion // 클래스 함수
	}
}
