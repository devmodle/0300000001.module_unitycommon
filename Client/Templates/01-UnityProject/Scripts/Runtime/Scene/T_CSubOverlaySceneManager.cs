...
namespace OverlayScene {
	...
	public partial class CSubOverlaySceneManager : COverlaySceneManager {
		...
		private void UpdateUIsState() {
			...
			CSceneManager.GetSceneManager<GameScene.CSubGameSceneManager>(KCDefine.B_SCENE_N_PLAY)?.gameObject.ExSendMsg(string.Empty, KCDefine.U_FUNC_N_UPDATE_UIS_STATE, null, false);
