...
namespace NSEngine {
	...
	public partial class CEFX : CEObjComponent {
		...
		public virtual void Init(STParams a_stParams) {
			...
			this.TargetParticle?.ExSetSortingOrder(Access.GetSortingOrderInfo(a_stParams.m_stFXInfo.m_eFXKinds));
	...
	public partial class CEFX : CEObjComponent {
		#region 클래스 함수
		/** 효과 매개 변수를 생성한다 */
		public static STParams MakeParams(CEngine a_oEngine, STFXInfo a_stFXInfo, CEController a_oController = null, string a_oKeyPoolGameObjs = KCDefine.B_TEXT_EMPTY) {
			return new STParams() {
				m_stBase = CEObjComponent.MakeParams(a_oEngine, a_oController, a_oKeyPoolGameObjs), m_stFXInfo = a_stFXInfo
			};
		}
		#endregion // 클래스 함수
	}
