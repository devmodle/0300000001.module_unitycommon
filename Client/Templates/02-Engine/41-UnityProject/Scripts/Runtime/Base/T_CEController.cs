	...
	public abstract partial class CEController : CEComponent {
		...
		public override void OnUpdate(float a_fTimeDelta) {
			...
			if(CSceneManager.IsRunningApp) {
				switch(this.State) {
					case EState.FX: this.HandleFXState(a_fTimeDelta); break;
					case EState.IDLE: this.HandleIdleState(a_fTimeDelta); break;
					case EState.MOVE: this.HandleMoveState(a_fTimeDelta); break;
					case EState.SKILL: this.HandleSkillState(a_fTimeDelta); break;
					case EState.APPEAR: this.HandleAppearState(a_fTimeDelta); break;
					case EState.DISAPPEAR: this.HandleDisappearState(a_fTimeDelta); break;
				}
