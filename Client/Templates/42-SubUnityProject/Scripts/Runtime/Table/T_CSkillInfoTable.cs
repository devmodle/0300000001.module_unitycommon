...
public struct STSkillInfo {
	...
	public EApplyKinds m_eSkillApplyKinds;
	...
	public EApplyType SkillApplyType => (EApplyType)((int)m_eSkillApplyKinds).ExKindsToType();
	public EApplyKinds BaseSkillApplyKinds => (EApplyKinds)((int)m_eSkillApplyKinds).ExKindsToSubKindsType();
	#endregion // 프로퍼티
	...
	public STSkillInfo(SimpleJSON.JSONNode a_oSkillInfo) {
		...
		m_eSkillApplyKinds = a_oSkillInfo[KCDefine.U_KEY_SKILL_APPLY_KINDS].ExIsValid() ? (EApplyKinds)a_oSkillInfo[KCDefine.U_KEY_SKILL_APPLY_KINDS].AsInt : EApplyKinds.NONE;
