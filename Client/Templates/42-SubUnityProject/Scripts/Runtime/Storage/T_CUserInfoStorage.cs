...
public partial class CUserInfoStorage : CSingleton<CUserInfoStorage> {
	...
	public bool IsPurchaseRemoveAds => Access.GetItemTargetVal(CGameInfoStorage.Inst.PlayCharacterID, EItemKinds.NON_CONSUMABLE_ITEM_REMOVE_ADS_01, ETargetKinds.ABILITY_TARGET, (int)EAbilityKinds.STAT_ABILITY_NUMS) > KCDefine.B_VAL_0_INT;
	#endregion // 프로퍼티
