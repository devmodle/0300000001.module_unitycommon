...
namespace SampleEngineName {
	...
	public partial class CEItem : CEComponent {
		...
		public override void SetupAbilityVals() {
			...
			var oAbilityTargetInfoDict = (m_stParams.m_oItemInfo != null) ? m_stParams.m_oItemInfo.m_oAbilityTargetInfoDict : m_stParams.m_stItemInfo.m_oAbilityTargetInfoDict;
