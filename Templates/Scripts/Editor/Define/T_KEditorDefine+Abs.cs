...
public static partial class KEditorDefine {
	...
	public static readonly Dictionary<string, string> B_UNITY_PKGS_DEPENDENCY_LIST = new Dictionary<string, string>() {
		...
		["unitymodule.common.ads"] = "https://sd.lee:NSString132!@gitlab.com/9tapmodule.repository/unitymodule_common_ads_client.git#1.0.1",
#endif			// #if ADS_ENABLE || ADS_MODULE_ENABLE

#if FLURRY_ENABLE || FLURRY_MODULE_ENABLE
		["unitymodule.common.flurry"] = "https://sd.lee:NSString132!@gitlab.com/9tapmodule.repository/unitymodule_common_flurry_client.git#1.0.1",
#endif			// #if FLURRY_ENABLE || FLURRY_MODULE_ENABLE

#if TENJIN_ENABLE || TENJIN_MODULE_ENABLE
		["unitymodule.common.tenjin"] = "https://sd.lee:NSString132!@gitlab.com/9tapmodule.repository/unitymodule_common_tenjin_client.git#1.0.1",
#endif			// #if TENJIN_ENABLE || TENJIN_MODULE_ENABLE

#if FACEBOOK_ENABLE || FACEBOOK_MODULE_ENABLE
		["unitymodule.common.facebook"] = "https://sd.lee:NSString132!@gitlab.com/9tapmodule.repository/unitymodule_common_facebook_client.git#1.0.1",
		...
		["unitymodule.common.unityservice"] = "https://sd.lee:NSString132!@gitlab.com/9tapmodule.repository/unitymodule_common_unityservice_client.git#1.0.1",
#endif			// #if UNITY_SERVICE_ENABLE || UNITY_SERVICE_MODULE_ENABLE

#if SINGULAR_ENABLE || SINGULAR_MODULE_ENABLE
		["unitymodule.common.singular"] = "https://sd.lee:NSString132!@gitlab.com/9tapmodule.repository/unitymodule_common_singular_client.git#1.0.1",
#endif			// #if SINGULAR_ENABLE || SINGULAR_MODULE_ENABLE

#if GAME_CENTER_ENABLE || GAME_CENTER_MODULE_ENABLE
		["unitymodule.common.gamecenter"] = "https://sd.lee:NSString132!@gitlab.com/9tapmodule.repository/unitymodule_common_gamecenter_client.git#1.0.1",
