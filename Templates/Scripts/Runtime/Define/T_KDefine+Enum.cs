...
public enum ESaleProductKinds {
	...
	// 샘플 소모 상품 10,020,000 (단일 상품)
	SINGLE_SAMPLE_CONSUMABLE = ESaleProductKinds.SINGLE_REMOVE_ADS + KCDefine.B_UNIT_TYPE_TO_KINDS_TYPE,

	// 샘플 비소모 상품 10,030,000 (단일 상품)
	SINGLE_SAMPLE_NON_CONSUMABLE = ESaleProductKinds.SINGLE_SAMPLE_CONSUMABLE + KCDefine.B_UNIT_TYPE_TO_KINDS_TYPE,
