...
public static partial class Func {
	...
	public static void BuyItem(STItemSaleInfo a_stItemSaleInfo, List<long> a_oNumExtraItemsList = null, long a_nExtraPrice = KCDefine.B_VAL_0_INT, bool a_bIsIgnoreAcquire = false) {
		...
		// 코인 비용이 존재 할 경우
		if(a_stItemSaleInfo.m_oPriceInfoList.ExTryGetPriceInfo(EPriceKinds.GOODS_COINS, out STPriceInfo stPriceInfo) && stPriceInfo.IntPrice + a_nExtraPrice > KCDefine.B_VAL_0_INT) {
