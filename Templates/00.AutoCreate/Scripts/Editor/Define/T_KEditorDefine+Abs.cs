...
public static partial class KEditorDefine {
	...
	public static readonly Dictionary<string, string> B_UNITY_PKGS_DEPENDENCY_DICT = new Dictionary<string, string>() {
		...
		["module.unitycommonads"] = "https://9tap:glpat-LxsZyPNZ5cNEPyxUPNaC@gitlab.com/9tapmodule.repository/0300000001.module_unitycommonads_client.git#2.7.7",
#endif			// #if ADS_ENABLE || ADS_MODULE_ENABLE

#if FLURRY_ENABLE || FLURRY_MODULE_ENABLE
		["module.unitycommonflurry"] = "https://9tap:glpat-LxsZyPNZ5cNEPyxUPNaC@gitlab.com/9tapmodule.repository/0300000001.module_unitycommonflurry_client.git#2.7.7",
#endif			// #if FLURRY_ENABLE || FLURRY_MODULE_ENABLE

#if FACEBOOK_ENABLE || FACEBOOK_MODULE_ENABLE
		["module.unitycommonfacebook"] = "https://9tap:glpat-LxsZyPNZ5cNEPyxUPNaC@gitlab.com/9tapmodule.repository/0300000001.module_unitycommonfacebook_client.git#2.7.7",
#endif			// #if FACEBOOK_ENABLE || FACEBOOK_MODULE_ENABLE

#if FIREBASE_ENABLE || FIREBASE_MODULE_ENABLE
		["module.unitycommonfirebase"] = "https://9tap:glpat-LxsZyPNZ5cNEPyxUPNaC@gitlab.com/9tapmodule.repository/0300000001.module_unitycommonfirebase_client.git#2.7.7",
#endif			// #if FIREBASE_ENABLE || FIREBASE_MODULE_ENABLE

#if APPS_FLYER_ENABLE || APPS_FLYER_MODULE_ENABLE
		["module.unitycommonappsflyer"] = "https://9tap:glpat-LxsZyPNZ5cNEPyxUPNaC@gitlab.com/9tapmodule.repository/0300000001.module_unitycommonappsflyer_client.git#2.7.7",
#endif			// #if APPS_FLYER_ENABLE || APPS_FLYER_MODULE_ENABLE

#if GAME_CENTER_ENABLE || GAME_CENTER_MODULE_ENABLE
		["module.unitycommongamecenter"] = "https://9tap:glpat-LxsZyPNZ5cNEPyxUPNaC@gitlab.com/9tapmodule.repository/0300000001.module_unitycommongamecenter_client.git#2.7.7",
		...
		["module.unitycommonnoti"] = "https://9tap:glpat-LxsZyPNZ5cNEPyxUPNaC@gitlab.com/9tapmodule.repository/0300000001.module_unitycommonnoti_client.git#2.7.7",
#endif			// #if NOTI_ENABLE || NOTI_MODULE_ENABLE

#if PLAYFAB_ENABLE || PLAYFAB_MODULE_ENABLE
		["module.unitycommonplayfab"] = "https://9tap:glpat-LxsZyPNZ5cNEPyxUPNaC@gitlab.com/9tapmodule.repository/0300000001.module_unitycommonplayfab_client.git#2.7.7"
