...
namespace MainScene {
	...
	public partial class CSubMainSceneManager : CMainSceneManager, IEnhancedScrollerDelegate {
		...
		private void AwakeSetup() {
			...
			m_oIDInfoDict.ExReplaceVal(EKey.SEL_ID_INFO, (ePlayMode == EPlayMode.NORM && CGameInfoStorage.Inst.PlayEpisodeInfo.m_stIDInfo.m_nID01 > KCDefine.B_IDX_INVALID) ? CGameInfoStorage.Inst.PlayEpisodeInfo.m_stIDInfo : CFactory.MakeIDInfo(KCDefine.B_VAL_0_INT));
