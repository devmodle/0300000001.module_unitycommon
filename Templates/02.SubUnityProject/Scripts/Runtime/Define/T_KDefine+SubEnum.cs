...
public static partial class KEnumVal {
	...
	// 어빌리티 종류 {
	public const int AK_ADD_STAT_SUB_TYPE_VAL = (int)EAbilityValType.ADD;
	public const int AK_MULTIPLY_STAT_SUB_TYPE_VAL = (int)EAbilityValType.MULTIPLY;

	public const int AK_ADD_STAT_SUB_TYPE = ((int)EEnumVal.TYPE * (int)EAbilityType.STAT) + ((int)EEnumVal.SUB_TYPE * KEnumVal.AK_ADD_STAT_SUB_TYPE_VAL);
	public const int AK_MULTIPLY_STAT_SUB_TYPE = ((int)EEnumVal.TYPE * (int)EAbilityType.STAT) + ((int)EEnumVal.SUB_TYPE * KEnumVal.AK_MULTIPLY_STAT_SUB_TYPE_VAL);
	// 어빌리티 종류 }
	#endregion			// 기본
}
...
public enum EAbilityKinds {
	...
	#region 스탯
	// 0 {
	STAT_LV = KEnumVal.AK_ADD_STAT_SUB_TYPE + (EEnumVal.KINDS_TYPE * 0) + (EEnumVal.SUB_KINDS_TYPE * 0),
	STAT_EXP = KEnumVal.AK_ADD_STAT_SUB_TYPE + (EEnumVal.KINDS_TYPE * 0) + (EEnumVal.SUB_KINDS_TYPE * 1),
	STAT_NUMS = KEnumVal.AK_ADD_STAT_SUB_TYPE + (EEnumVal.KINDS_TYPE * 0) + (EEnumVal.SUB_KINDS_TYPE * 2),
	STAT_ENHANCE = KEnumVal.AK_ADD_STAT_SUB_TYPE + (EEnumVal.KINDS_TYPE * 0) + (EEnumVal.SUB_KINDS_TYPE * 3),

	STAT_HP_01 = KEnumVal.AK_ADD_STAT_SUB_TYPE + (EEnumVal.KINDS_TYPE * 1) + (EEnumVal.SUB_KINDS_TYPE * 0), STAT_HP_02,
	STAT_MP_01 = KEnumVal.AK_ADD_STAT_SUB_TYPE + (EEnumVal.KINDS_TYPE * 1) + (EEnumVal.SUB_KINDS_TYPE * 1), STAT_MP_02,
	STAT_SP_01 = KEnumVal.AK_ADD_STAT_SUB_TYPE + (EEnumVal.KINDS_TYPE * 1) + (EEnumVal.SUB_KINDS_TYPE * 2), STAT_SP_02,

	STAT_RECOVERY_01 = KEnumVal.AK_ADD_STAT_SUB_TYPE + (EEnumVal.KINDS_TYPE * 2) + (EEnumVal.SUB_KINDS_TYPE * 0), STAT_RECOVERY_02,
	STAT_HP_RECOVERY_01 = KEnumVal.AK_ADD_STAT_SUB_TYPE + (EEnumVal.KINDS_TYPE * 2) + (EEnumVal.SUB_KINDS_TYPE * 1), STAT_HP_RECOVERY_02,
	STAT_MP_RECOVERY_01 = KEnumVal.AK_ADD_STAT_SUB_TYPE + (EEnumVal.KINDS_TYPE * 2) + (EEnumVal.SUB_KINDS_TYPE * 2), STAT_MP_RECOVERY_02,
	STAT_SP_RECOVERY_01 = KEnumVal.AK_ADD_STAT_SUB_TYPE + (EEnumVal.KINDS_TYPE * 2) + (EEnumVal.SUB_KINDS_TYPE * 3), STAT_SP_RECOVERY_02,

	STAT_ATK_01 = KEnumVal.AK_ADD_STAT_SUB_TYPE + (EEnumVal.KINDS_TYPE * 3) + (EEnumVal.SUB_KINDS_TYPE * 0), STAT_ATK_02,
	STAT_P_ATK_01 = KEnumVal.AK_ADD_STAT_SUB_TYPE + (EEnumVal.KINDS_TYPE * 3) + (EEnumVal.SUB_KINDS_TYPE * 1), STAT_P_ATK_02,
	STAT_M_ATK_01 = KEnumVal.AK_ADD_STAT_SUB_TYPE + (EEnumVal.KINDS_TYPE * 3) + (EEnumVal.SUB_KINDS_TYPE * 2), STAT_M_ATK_02,

	STAT_DEF_01 = KEnumVal.AK_ADD_STAT_SUB_TYPE + (EEnumVal.KINDS_TYPE * 4) + (EEnumVal.SUB_KINDS_TYPE * 0), STAT_DEF_02,
	STAT_P_DEF_01 = KEnumVal.AK_ADD_STAT_SUB_TYPE + (EEnumVal.KINDS_TYPE * 4) + (EEnumVal.SUB_KINDS_TYPE * 1), STAT_P_DEF_02,
	STAT_M_DEF_01 = KEnumVal.AK_ADD_STAT_SUB_TYPE + (EEnumVal.KINDS_TYPE * 4) + (EEnumVal.SUB_KINDS_TYPE * 2), STAT_M_DEF_02,

	STAT_RANGE_01 = KEnumVal.AK_ADD_STAT_SUB_TYPE + (EEnumVal.KINDS_TYPE * 5) + (EEnumVal.SUB_KINDS_TYPE * 0), STAT_RANGE_02,
	STAT_ATK_RANGE_01 = KEnumVal.AK_ADD_STAT_SUB_TYPE + (EEnumVal.KINDS_TYPE * 5) + (EEnumVal.SUB_KINDS_TYPE * 1), STAT_ATK_RANGE_02,
	STAT_VIEW_RANGE_01 = KEnumVal.AK_ADD_STAT_SUB_TYPE + (EEnumVal.KINDS_TYPE * 5) + (EEnumVal.SUB_KINDS_TYPE * 2), STAT_VIEW_RANGE_02,

	STAT_SPEED_01 = KEnumVal.AK_ADD_STAT_SUB_TYPE + (EEnumVal.KINDS_TYPE * 6) + (EEnumVal.SUB_KINDS_TYPE * 0), STAT_SPEED_02,
	STAT_ATK_SPEED_01 = KEnumVal.AK_ADD_STAT_SUB_TYPE + (EEnumVal.KINDS_TYPE * 6) + (EEnumVal.SUB_KINDS_TYPE * 1), STAT_ATK_SPEED_02,
	STAT_MOVE_SPEED_01 = KEnumVal.AK_ADD_STAT_SUB_TYPE + (EEnumVal.KINDS_TYPE * 6) + (EEnumVal.SUB_KINDS_TYPE * 2), STAT_MOVE_SPEED_02,

	STAT_DELAY_01 = KEnumVal.AK_ADD_STAT_SUB_TYPE + (EEnumVal.KINDS_TYPE * 7) + (EEnumVal.SUB_KINDS_TYPE * 0), STAT_DELAY_02,
	STAT_ATK_DELAY_01 = KEnumVal.AK_ADD_STAT_SUB_TYPE + (EEnumVal.KINDS_TYPE * 7) + (EEnumVal.SUB_KINDS_TYPE * 1), STAT_ATK_DELAY_02,

	STAT_RATE_01 = KEnumVal.AK_ADD_STAT_SUB_TYPE + (EEnumVal.KINDS_TYPE * 8) + (EEnumVal.SUB_KINDS_TYPE * 0), STAT_RATE_02,
	STAT_HIT_RATE_01 = KEnumVal.AK_ADD_STAT_SUB_TYPE + (EEnumVal.KINDS_TYPE * 8) + (EEnumVal.SUB_KINDS_TYPE * 1), STAT_HIT_RATE_02,
	STAT_AVOID_RATE_01 = KEnumVal.AK_ADD_STAT_SUB_TYPE + (EEnumVal.KINDS_TYPE * 8) + (EEnumVal.SUB_KINDS_TYPE * 2), STAT_AVOID_RATE_03,
	STAT_CRITICAL_RATE_01 = KEnumVal.AK_ADD_STAT_SUB_TYPE + (EEnumVal.KINDS_TYPE * 8) + (EEnumVal.SUB_KINDS_TYPE * 3), STAT_CRITICAL_RATE_04,
	// 0 }

	// 10,000,000 {
	[System.Obsolete] STAT_LV_INCR = KEnumVal.AK_MULTIPLY_STAT_SUB_TYPE + (EEnumVal.KINDS_TYPE * 0) + (EEnumVal.SUB_KINDS_TYPE * 0),
	STAT_EXP_INCR = KEnumVal.AK_MULTIPLY_STAT_SUB_TYPE + (EEnumVal.KINDS_TYPE * 0) + (EEnumVal.SUB_KINDS_TYPE * 1),
	[System.Obsolete] STAT_NUMS_INCR = KEnumVal.AK_MULTIPLY_STAT_SUB_TYPE + (EEnumVal.KINDS_TYPE * 0) + (EEnumVal.SUB_KINDS_TYPE * 2),
	[System.Obsolete] STAT_ENHANCE_INCR = KEnumVal.AK_MULTIPLY_STAT_SUB_TYPE + (EEnumVal.KINDS_TYPE * 0) + (EEnumVal.SUB_KINDS_TYPE * 3),

	STAT_HP_INCR_01 = KEnumVal.AK_MULTIPLY_STAT_SUB_TYPE + (EEnumVal.KINDS_TYPE * 1) + (EEnumVal.SUB_KINDS_TYPE * 0),
	STAT_MP_INCR_01 = KEnumVal.AK_MULTIPLY_STAT_SUB_TYPE + (EEnumVal.KINDS_TYPE * 1) + (EEnumVal.SUB_KINDS_TYPE * 1),
	STAT_SP_INCR_01 = KEnumVal.AK_MULTIPLY_STAT_SUB_TYPE + (EEnumVal.KINDS_TYPE * 1) + (EEnumVal.SUB_KINDS_TYPE * 2),

	STAT_RECOVERY_INCR_01 = KEnumVal.AK_MULTIPLY_STAT_SUB_TYPE + (EEnumVal.KINDS_TYPE * 2) + (EEnumVal.SUB_KINDS_TYPE * 0),
	STAT_HP_RECOVERY_INCR_01 = KEnumVal.AK_MULTIPLY_STAT_SUB_TYPE + (EEnumVal.KINDS_TYPE * 2) + (EEnumVal.SUB_KINDS_TYPE * 1),
	STAT_MP_RECOVERY_INCR_01 = KEnumVal.AK_MULTIPLY_STAT_SUB_TYPE + (EEnumVal.KINDS_TYPE * 2) + (EEnumVal.SUB_KINDS_TYPE * 2),
	STAT_SP_RECOVERY_INCR_01 = KEnumVal.AK_MULTIPLY_STAT_SUB_TYPE + (EEnumVal.KINDS_TYPE * 2) + (EEnumVal.SUB_KINDS_TYPE * 3),

	STAT_ATK_INCR_01 = KEnumVal.AK_MULTIPLY_STAT_SUB_TYPE + (EEnumVal.KINDS_TYPE * 3) + (EEnumVal.SUB_KINDS_TYPE * 0),
	STAT_P_ATK_INCR_01 = KEnumVal.AK_MULTIPLY_STAT_SUB_TYPE + (EEnumVal.KINDS_TYPE * 3) + (EEnumVal.SUB_KINDS_TYPE * 1),
	STAT_M_ATK_INCR_01 = KEnumVal.AK_MULTIPLY_STAT_SUB_TYPE + (EEnumVal.KINDS_TYPE * 3) + (EEnumVal.SUB_KINDS_TYPE * 2),

	STAT_DEF_INCR_01 = KEnumVal.AK_MULTIPLY_STAT_SUB_TYPE + (EEnumVal.KINDS_TYPE * 4) + (EEnumVal.SUB_KINDS_TYPE * 0),
	STAT_P_DEF_INCR_01 = KEnumVal.AK_MULTIPLY_STAT_SUB_TYPE + (EEnumVal.KINDS_TYPE * 4) + (EEnumVal.SUB_KINDS_TYPE * 1),
	STAT_M_DEF_INCR_01 = KEnumVal.AK_MULTIPLY_STAT_SUB_TYPE + (EEnumVal.KINDS_TYPE * 4) + (EEnumVal.SUB_KINDS_TYPE * 2),

	STAT_RANGE_INCR_01 = KEnumVal.AK_MULTIPLY_STAT_SUB_TYPE + (EEnumVal.KINDS_TYPE * 5) + (EEnumVal.SUB_KINDS_TYPE * 0),
	STAT_ATK_RANGE_INCR_01 = KEnumVal.AK_MULTIPLY_STAT_SUB_TYPE + (EEnumVal.KINDS_TYPE * 5) + (EEnumVal.SUB_KINDS_TYPE * 1),
	STAT_VIEW_RANGE_INCR_01 = KEnumVal.AK_MULTIPLY_STAT_SUB_TYPE + (EEnumVal.KINDS_TYPE * 5) + (EEnumVal.SUB_KINDS_TYPE * 2),

	STAT_SPEED_INCR_01 = KEnumVal.AK_MULTIPLY_STAT_SUB_TYPE + (EEnumVal.KINDS_TYPE * 6) + (EEnumVal.SUB_KINDS_TYPE * 0),
	STAT_ATK_SPEED_INCR_01 = KEnumVal.AK_MULTIPLY_STAT_SUB_TYPE + (EEnumVal.KINDS_TYPE * 6) + (EEnumVal.SUB_KINDS_TYPE * 1),
	STAT_MOVE_SPEED_INCR_01 = KEnumVal.AK_MULTIPLY_STAT_SUB_TYPE + (EEnumVal.KINDS_TYPE * 6) + (EEnumVal.SUB_KINDS_TYPE * 2),

	STAT_DELAY_INCR_01 = KEnumVal.AK_MULTIPLY_STAT_SUB_TYPE + (EEnumVal.KINDS_TYPE * 7) + (EEnumVal.SUB_KINDS_TYPE * 0),
	STAT_ATK_DELAY_INCR_01 = KEnumVal.AK_MULTIPLY_STAT_SUB_TYPE + (EEnumVal.KINDS_TYPE * 7) + (EEnumVal.SUB_KINDS_TYPE * 1),

	STAT_RATE_INCR_01 = KEnumVal.AK_MULTIPLY_STAT_SUB_TYPE + (EEnumVal.KINDS_TYPE * 8) + (EEnumVal.SUB_KINDS_TYPE * 0),
	STAT_HIT_RATE_INCR_01 = KEnumVal.AK_MULTIPLY_STAT_SUB_TYPE + (EEnumVal.KINDS_TYPE * 8) + (EEnumVal.SUB_KINDS_TYPE * 1),
	STAT_AVOID_RATE_INCR_01 = KEnumVal.AK_MULTIPLY_STAT_SUB_TYPE + (EEnumVal.KINDS_TYPE * 8) + (EEnumVal.SUB_KINDS_TYPE * 2),
	STAT_CRITICAL_RATE_INCR_01 = KEnumVal.AK_MULTIPLY_STAT_SUB_TYPE + (EEnumVal.KINDS_TYPE * 8) + (EEnumVal.SUB_KINDS_TYPE * 3),
	// 10,000,000 }
	#endregion			// 스탯
