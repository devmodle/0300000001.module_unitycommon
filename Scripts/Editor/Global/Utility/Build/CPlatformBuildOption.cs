...
public static partial class CPlatformBuildOption {
	...
	public static CProjInfoTable ProjInfoTable { get; private set; } = null;
	...
	public static void EditorInitialize() {
		...
		CPlatformBuildOption.ProjInfoTable = Resources.Load<CProjInfoTable>(KCDefine.U_SCRIPTABLE_PATH_G_PROJ_INFO_TABLE);
		CPlatformBuildOption.ProjInfoTable?.Awake();
		...
		if(CPlatformBuildOption.DefineSymbolTable != null) {
			...
			foreach(var stKeyValue in CPlatformBuildOption.DefineSymbolListContainer) {
				CPlatformBuildOption.AddDefineSymbol(stKeyValue.Key, KCEditorDefine.DS_DEFINE_S_IL2CPP_ENABLE);
				CPlatformBuildOption.AddDefineSymbol(stKeyValue.Key, KCEditorDefine.DS_DEFINE_S_USE_CUSTOM_PROJ_OPTION);
			}
		}
	}
