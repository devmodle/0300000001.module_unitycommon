...
public class CDragDispatcher : CComponent, IBeginDragHandler, IDragHandler, IEndDragHandler {
	#region 프로퍼티
	public System.Action<CDragDispatcher, PointerEventData> BeganCallback { get; set; } = null;
	public System.Action<CDragDispatcher, PointerEventData> DragCallback { get; set; } = null;
	public System.Action<CDragDispatcher, PointerEventData> EndedCallback { get; set; } = null;
	#endregion			// 프로퍼티
