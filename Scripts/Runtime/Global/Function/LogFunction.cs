...
public static partial class LogFunction {
	...
	public static void SendAppLaunchLog() {
		...
		CFlurryManager.Instance.SendLog(KDefine.U_LOG_NAME_APP_LAUNCH, null);
#endif			// #if FLURRY_ENABLE && FLURRY_ANALYTICS_ENABLE

#if FACEBOOK_ENABLE && FACEBOOK_ANALYTICS_ENABLE
		CFacebookManager.Instance.SendLog(KDefine.U_LOG_NAME_APP_LAUNCH, null);
#endif			// #if FACEBOOK_ENABLE && FACEBOOK_ANALYTICS_ENABLE

#if FIREBASE_ENABLE && FIREBASE_ANALYTICS_ENABLE
		CFirebaseManager.Instance.SendLog(KDefine.U_LOG_NAME_APP_LAUNCH, KDefine.U_LOG_KEY_USER_INFO, null);
#endif			// #if FIREBASE_ENABLE && FIREBASE_ANALYTICS_ENABLE

#if UNITY_SERVICE_ENABLE && UNITY_SERVICE_ANALYTICS_ENABLE
		CUnityServiceManager.Instance.SendLog(KDefine.U_LOG_NAME_APP_LAUNCH, null);
