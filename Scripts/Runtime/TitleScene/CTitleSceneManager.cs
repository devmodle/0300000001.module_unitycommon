		...
		public override void Awake() {
			...
			if(CSceneManager.IsAppInit) {
				...
				if(COptsInfoTable.Inst.EtcOptsInfo.m_bIsEnableTitleScene) {
					...
					m_oTextDict[EKey.VER_TEXT] = oVerText ?? CFactory.CreateCloneObj<TMP_Text>(KCDefine.U_OBJ_N_VER_TEXT, CResManager.Inst.GetRes<GameObject>(KCDefine.U_OBJ_P_G_INFO_TEXT), this.UpLeftUIs);
