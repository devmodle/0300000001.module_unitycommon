...
namespace SplashScene {
	...
	public abstract partial class CSplashSceneManager : CSceneManager {
		...
		private IEnumerator OnStart() {
			...
			CSceneManager.SetupQuality(oTargetFrameInfoDict.ContainsKey(Application.platform) ? (EQualityLevel)oTargetFrameInfoDict[Application.platform].Item1 : (EQualityLevel)CValTable.Inst.GetInt(KCDefine.VT_KEY_DEF_QUALITY_LEVEL));
